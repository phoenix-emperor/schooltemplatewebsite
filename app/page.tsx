        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
              ...
              bright future through quality education and innovative learning
              experiences.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              ...
              students for success in academics and life.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="card text-center">
              ...
              <p className="text-gray-600">
                Our rigorous curriculum and dedicated teachers ensure students
            ...
            <div className="card text-center">
              ...
              <p className="text-gray-600">
                We focus on building strong character, leadership skills, and
            ...
            <div className="card text-center">
              ...
              <p className="text-gray-600">
                State-of-the-art facilities and technology integration prepare
